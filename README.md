...
- **Options where you are looking** — the flyout header's **…** menu carries the settings you actually change while using a launcher — window mode, address bar, reload on open, where it opens, whether moving and resizing it sticks — without going to the settings window for them.
