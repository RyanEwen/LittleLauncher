...
| `LittleLauncher.Windows` | FlyoutWindow (+ `FlyoutWindow.EditMode.cs`, `FlyoutWindow.ExternalDrop.cs`), WebFlyoutWindow (+ `WebFlyoutWindow.Permissions.cs` — site permissions and page notifications), LauncherPanels, EditToolbarWindow, ItemEditorWindow, TextPromptWindow, LauncherSettingsWindow |
